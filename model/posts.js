...
const columns = ['id', 'title', 'text', 'thumbnail', 'friendly_url', 'create_at'];
const table = 'posts';
const columnsAdd = 'title, text, thumbnail, friendly_url, create_at';

exports.add = data => db.one('INSERT INTO posts(' + columnsAdd + ') VALUES(${title}, ${text}, ${thumbnail}, ${friendly_url}, ${create_at}) RETURNING id', data, a => a.id);
